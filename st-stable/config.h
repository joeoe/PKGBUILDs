 ...
 */
//static char *font = "Liberation:monospace:size=12:antialias=true:autohint=true";
//static char *font = "Hack Nerd Font:size=12:antialias=true:autohint=true";
static char *font = "Hack Nerd Font Mono:size=13:antialias=true:autohint=true:hintstyle=full";
/* static char *font2[] = { */
/* 	"Noto Color Emoji:size=13:style=Regular", */
/* 	/1* "Hack Nerd Font Mono:pixelsize=11:antialias=true:autohint=true", *1/ */
/* }; */
